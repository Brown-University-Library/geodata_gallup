...
rpath=os.path.join('requests','ponce_de_leon') # MODIFY BASED ON INPUT
select_file=os.path.join(rpath,'gallup_gpss_minority_vars - Mercedes Ponce de Leon.xlsx') #MODIFY BASED ON INPUT
survey_file=surveys[2] #MODIFY BASED ON INPUT
